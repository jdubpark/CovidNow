...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href=<?php relDistFile('covidnow.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> />
    <!-- <link rel="stylesheet" href=<?php relDistFile('universal.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> /> -->
    <?php if (defined('PAGE_NAME')): ?>
    <?php if (PAGE_NAME == 'home'): ?>
    <link rel="stylesheet" href=<?php relDistFile('home.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> />
    <?php elseif (PAGE_NAME == 'states'): ?>
    <link rel="stylesheet" href=<?php relDistFile('states.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> />
    <?php elseif (PAGE_NAME == 'about'): ?>
    <link rel="stylesheet" href=<?php relDistFile('about.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> />
    <?php endif; endif; ?>
    <?php if (defined('NEED_CSS_fa') && NEED_CSS_fa): ?>
    <link rel="stylesheet" href=<?php relDistFile('_fa.min.css?cbv=df9470708c90925becd7be1b9d29e95f', 'style');?> />
    <?php endif; ?>
    <!-- Social Media -->
