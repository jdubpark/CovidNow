...
<html lang="en">
  <head>
    ...
    <title>COVID-19 Wikipedia - CovidNow</title>
    ...
    <link rel="stylesheet" href="../lib/style/wiki.css<?php echo "?v=".filemtime("../lib/style/wiki.css"); ?>" />
    <!-- Fonts -->
  ...
  <body>
    ...
    <div id="page">
      ...
      <div id="wiki" class="wiki">
        <h2><a href="./myths">Myths</a></h2>
        <h2><a href="./faq">FAQ</a></h2>
        <h2><a href="./research">Research</a></h2>
        <h2><a href="./prevention">Prevention</a></h2>
      </div>
